        ...
        <c:if test="${not empty sessionScope.resumes}">
            <c:forEach items="${sessionScope.resumes}" var="resume">
                ...
                <tr>
                    ...
                    <td></td>
                    <td><a href="Informinterview.action?rid=${resume.rid}">通知面试</a></td>
                </tr>
            </c:forEach>
        </c:if>
        
  <tr>
  <td colspan="12" align="center"><a href="admin.jsp"><input type="button" value="返回"></a></td>
  </tr>
</table>
</body>
</html>
